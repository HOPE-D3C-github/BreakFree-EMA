...
for (participant in dat_master$participant_id){
  ...
  participant_battery_binned_ranges <- dat_battery_participant_v2 %>% 
  ...
  participant_battery_binned_ranges <- participant_battery_binned_ranges %>% 
    add_row(
      data.frame(
        ...
        unix_datetime_end = participant_battery_binned_ranges$unix_datetime_start[1], datetime_hrts_UTC_end = participant_battery_binned_ranges$datetime_hrts_UTC_start[1],
