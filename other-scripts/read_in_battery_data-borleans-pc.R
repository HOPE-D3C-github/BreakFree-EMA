...
dat_master <- readRDS(file = file.path(path_breakfree_output_data, "masterlist.rds"))
...
remove(dat_csv_file_counts_cc2, list_battery_data_cc2, tmp)
...
# 7/26/2022 removed the below line because it truncates the end range when binning on battery levels
